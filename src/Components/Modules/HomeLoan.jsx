...
const HomeLoan = () => {
  ...
  useEffect(() => {
    if (location.state) {
      setFormData({ userID: localStorage.getItem("userID"), employment_type: location.state.employment_type, personalloanform_businessloanform_id: location.state.param });
    }
  }, [location.state]);
  ...
  useEffect(() => {
    if (formData.employment_type === "salaried" && formData.personalloanform_businessloanform_id === "") {
      navigate("/personalloan", { state: { param: formData.employment_type } }) // Clear errors for the changed field
    } else if (formData.employment_type === "selfemployed" && formData.personalloanform_businessloanform_id === "") {
      navigate("/businessloan", { state: { param: formData.employment_type } }) // Clear errors for the changed field
    }
  ...
  const validateForm = () => {
    ...
    if (!formData2.ownership_proof) {
      newErrors.ownership_proof = "Files is Requried";
    }
    if (!formData2.mutation_copy) {
      newErrors.mutation_copy = "mutation_copy Files is Requried";
    }
    if (!formData2.land_revenue) {
      newErrors.land_revenue = "Income Files is Requried";
    }
    if (!formData2.lpc) {
      newErrors.lpc = "Regproof is Requried";
    }
    if (!formData2.propety_map) {
      newErrors.propety_map = "Last Two Year AS is Requried";
    }

    if (!formData2.thirteen_year_chaindeed) {
      newErrors.thirteen_year_chaindeed = "Last two year  is Requried";
    }
  ...
  const handleClick = async (e) => {
    ...
    try {
      ...
      let reqOptions = {
        // url: "http://15.207.195.184:8000/api/v1/homeLoanForm",
        url: `${backendUrl}/homeLoanForm`,
        method: "POST",
        headers: headersList,
        data: bodyContent,
      }
      ...
      if (response) {
        ...
        // const response2 = await axios.post(`http://15.207.195.184:8000/api/v1/homeloanformUploadfiles/${response.data.id}`, newformData, {
        const response2 = await axios.post(`${backendUrl}/homeloanformUploadfiles/${response.data.id}`, newformData, {
          headers: {
                      ...
                      <div className="row">
                        ...
                        <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                          <div className=" mb-5 mb-lg-0">
                            <h4>Land Purchase</h4>
                            <p className="mb-0">
                              parv Financial Servicesoffers home loan for land purchase to
                                ...
                                <div className="row">
                                    ...
                                    <span className="mx-4 d-flex">
                                      ...
                                      <span className="mx-2 d-flex">
                                        ...
                                        <input
                                          ...
                                          className="m-2"
                                          value="selfemployed"
                                          checked={formData.employment_type === "selfemployed"}
                                          onChange={handleInputChange}
                                        />
                                      </span>
                                      <br />
                                  ...
                                  <div className="col-xl-4 col-lg-2 col-md-12 col-sm-12 col-12">
                                    <div className="mb-3">
                                      ...
                                      {formData2.ownership_proof && (
                                        <p>
                                          Selected File:{" "}
                                          {formData2.ownership_proof.name}
                                        </p>
                                      )}
                                    </div>
                                  </div>
                                  <div className="col-xl-4 col-lg-2 col-md-12 col-sm-12 col-12">
                                    <div className="mb-3">
                                      ...
                                      ></label>
                                      <input
                                        id="thirteen_year_chaindeed "
                                        name="thirteen_year_chaindeed "
                                        type="file"
                                        onChange={(e) =>
                                          handleFileChange(e, "thirteen_year_chaindeed")
                                        }
                                        placeholder="Last Two Year ."
                                        className="form-control"
                                      />
                                      {errors.thirteen_year_chaindeed && (
                                        <div className="text-danger">
                                          {errors.thirteen_year_chaindeed}
                                        </div>
                                      )}
                                      {formData2.thirteen_year_chaindeed && (
                                        <p>
                                          Selected File:{" "}
                                          {formData2.thirteen_year_chaindeed.name}
                                        </p>
                                      )}
                                    </div>
                                  </div>
                                  <div className="col-xl-4 col-lg-2 col-md-12 col-sm-12 col-12">
                                    <div className="mb-3">
                                      ...
                                      <input
                                        ...
                                        type="file"
                                        onChange={(e) =>
                                          handleFileChange(e, "land_revenue")
                                        }
                                      ...
                                      {formData2.land_revenue && (
                                        <p>
                                          Selected File:{" "}
                                          {formData2.land_revenue.name}
                                        </p>
                                      )}
                                    </div>
                                  </div>
                                  ...
                                  <div className="col-xl-4 col-lg-2 col-md-12 col-sm-12 col-12">
                                    <div className="mb-3">
                                      ...
                                      <input
                                        ...
                                        type="file"
                                        onChange={(e) =>
                                          handleFileChange(e, "mutation_copy")
                                        }

                                        className="form-control"
                                      />
                                      {errors.mutation_copy && (
                                        <div className="text-danger">
                                          {errors.mutation_copy}
                                        </div>
                                      )}
                                      {formData2.mutation_copy && (
                                        <p>
                                          Selected File: {formData2.mutation_copy.name}
                                        </p>
                                      )}
                                    </div>
                                  </div>
                                  ...
                                  <div className="col-xl-4 col-lg-2 col-md-12 col-sm-12 col-12">
                                    <div className="mb-3">
                                      ...
                                      <input
                                        ...
                                        type="file"
                                        onChange={(e) =>
                                          handleFileChange(e, "propety_map")
                                        }
                                      ...
                                      {formData2.propety_map && (
                                        <p>
                                          Selected File:{" "}
                                          {formData2.propety_map.name}
                                        </p>
                                      )}
                                    </div>
                                  </div>
