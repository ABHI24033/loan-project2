                      ...
                      <div className="row">
                        <div className="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                          ...
                          <div className="card text-center mb-4 py-5">
                            ...
                            <div className="card-body">
                              <h3 className="card-title">Prabhu ram</h3>
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                          <div className="card text-center mb-4 py-5">
                            <img className="card-img-top" src="https://www.w3schools.com/howto/img_avatar.png" alt="Card image cap" />
                            <div className="card-body">
                              <h3 className="card-title">SATYENDRA KUMAR</h3>
                              <p className="card-text">I am a business man from ARA ( GIDHA) involving in plants nursery  business. I got the CC of 20 lakhs. </p>
                              <p className="card-text"><small className="text-muted">Last updated 3 mins ago</small></p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                          <div className="card text-center mb-4 py-5">
                            <img className="card-img-top" src="https://www.w3schools.com/howto/img_avatar.png" alt="Card image cap" />
                            <div className="card-body">
                              <h3 className="card-title">ADITYA SHARMA</h3>
                              <p className="card-text">I am a business man from patna involing in lift &escillator business. I got the loan of 5 lakhs for my business through parv financial services. Good services. </p>
                              <p className="card-text"><small className="text-muted">Last updated 3 mins ago</small></p>
                            </div>
                          </div>
                        </div>
