        ...
        <div className="container">
          ...
          <div className="row mb-8">
            ...
            <div className="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
              ...
              {"                      "}
              <div className="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3609.3929195665055!2d84.2614758745365!3d25.2236876306288!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x398d9e2c64cf6b71%3A0x94949031d5d464c7!2sHotel%20new%20Mayur!5e0!3m2!1sen!2sin!4v1709198189136!5m2!1sen!2sin" style={{ border: "0" }} width="450" height="200" allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
              </div>
            </div>
            ...
            <div className="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
              <div className="mb-3 footer-links">
                ...
                <ul className="list-unstyled text-muted">
                  ...
                  <li className="d-flex">
                    {"                  "}
                    <a className="fs-5" href="/goldloan">
                      {"                    "}
                      <i className="bi bi-chevron-right fs-6 me-2" />
                      {/*Gold Loan*/}Home Loan
                    </a>
                  ...
                  <li className="d-flex">
                    ...
                    <a className="fs-5" href="/businessloan">
                      {"                    "}
                      <i className="bi bi-chevron-right fs-6 me-2" />
                      {/*Business Loan*/}Loan aganist property
                    </a>
                  </li>
